...
${OBJECTDIR}/util/calc_crc.o: util/calc_crc.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util/calc_crc.o util/calc_crc.c

${OBJECTDIR}/util/hashset.o: util/hashset.c
	${MKDIR} -p ${OBJECTDIR}/util
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util/hashset.o util/hashset.c

${OBJECTDIR}/util/linklist.o: util/linklist.c
	${MKDIR} -p ${OBJECTDIR}/util
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util/linklist.o util/linklist.c

${OBJECTDIR}/util/stringtools.o: util/stringtools.c
	${MKDIR} -p ${OBJECTDIR}/util
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util/stringtools.o util/stringtools.c
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/stringtools_test.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.c} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   -L. -lcunit 


${TESTDIR}/tests/stringtools_test.o: tests/stringtools_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/stringtools_test.o tests/stringtools_test.c
...
${OBJECTDIR}/util/calc_crc_nomain.o: ${OBJECTDIR}/util/calc_crc.o util/calc_crc.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util/calc_crc_nomain.o util/calc_crc.c;\
	else  \
...
${OBJECTDIR}/util/hashset_nomain.o: ${OBJECTDIR}/util/hashset.o util/hashset.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util/hashset_nomain.o util/hashset.c;\
	else  \
...
${OBJECTDIR}/util/linklist_nomain.o: ${OBJECTDIR}/util/linklist.o util/linklist.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util/linklist_nomain.o util/linklist.c;\
	else  \
...
${OBJECTDIR}/util/stringtools_nomain.o: ${OBJECTDIR}/util/stringtools.o util/stringtools.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util/stringtools_nomain.o util/stringtools.c;\
	else  \
